...
---
20. Для реализации функции `sleep(ms)` в асинхронном контексте можно воспользоваться промисами и функцией `setTimeout()`, чтобы приостановить выполнение асинхронной функции на определенное количество миллисекунд. Вот пример реализации этой функции:
```javascript
function sleep(ms) {
