...
---
19. Вы можете реализовать toggle-компонент, подобный тому, что используется в iPhone, с помощью HTML и CSS, без использования JavaScript. Для этого можно воспользоваться элементами формы и псевдоклассами CSS для изменения внешнего вида в зависимости от состояния переключателя. Вот пример такой реализации:
```html
