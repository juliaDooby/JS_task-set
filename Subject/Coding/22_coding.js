...
---
22. Для нахождения всех HTML-ссылок в строке можно использовать регулярное выражение, которое будет соответствовать шаблону HTML-ссылки. Вот пример функции с регулярным выражением для этой задачи:
```javascript
